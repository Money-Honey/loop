...
public class EntryPoint {
    ...
    public EntryPoint(Properties props) {
        this.props = props;
    }

    void configureAndStart() throws Exception {

        Module dataBaseModule = createDataBaseModule("nosql", props);

        Server server = createServer(dataBaseModule);
    ...
    private Server createServer(final Module dataBaseModule) {
        ...
        context.addEventListener(new GuiceServletContextListener() {
            ...
            protected Injector getInjector() {
                Injector injector = Guice.createInjector(new BaseModule(), dataBaseModule);

                //toDo: work around about this
